				...
				<div class="full-width">
					...
					<div class="offers">
						<div class="row">
							...
							<article class="one-fourth">
								<figure><a href="#" title=""><img src="images/uploads/img1.jpg" alt="" /></a></figure>
								<div class="details">
									<h3>Winter beach escapes 30% off</h3>
							...
							<article class="one-fourth">
								...
								<div class="details">
									<h3>Spend New Year‘s Eve in Paris</h3>
							...
							<!--column-->
							<article class="one-fourth">
								<figure><a href="#" title=""><img src="images/uploads/img2.jpg" alt="" /></a></figure>
								<div class="details">
									<h3>Skiing weekends in the Alpes</h3>
									<a href="#" title="Explore our deals" class="gradient-button">Explore our deals</a>
								</div>
							</article>
							<!--//column-->
							...
							<!--column-->
							<article class="one-fourth">
								<figure><a href="#" title=""><img src="images/uploads/thailand.jpg" alt="" /></a></figure>
								<div class="details">
									<h3>Our weekly top offer: Thailand</h3>
									<a href="#" title="More info" class="gradient-button">More info</a>
								</div>
							</article>
							<!--//column-->
					...
					<div class="destinations">
						<div class="row">
							...
							<!--column-->
							<article class="one-fourth">
								<figure><a href="#" title=""><img src="images/uploads/prague.jpg" alt="" /></a></figure>
								<div class="details">
									<a href="#" title="View all" class="gradient-button">View all</a>
									<h4>Prague</h4>
					...
					<div class="boxes">
						...
						<article class="one-fourth">
							<div>
								...
								<p>All Zim Tourism Hotels fulfil strict selection criteria. Each hotel is chosen individually and inclusion cannot be bought. </p>
							</div>
						</article>
						<!--//column-->
						...
						<article class="one-fourth">
							<div>
								...
								<p>Zim Tourisms’s team will cater to your special requests. We offer expert and passionate advice for finding the right hotel. </p>
							</div>
						</article>
						<!--//column-->
						...
						<article class="one-fourth">
							<div>
								...
								<p>Zim Tourism reservation system is secure and your credit card and personal information is encrypted.We work to high standards and guarantee your privacy. </p>
							</div>
						</article>
						<!--//column-->
						...
						<article class="one-fourth">
							<div>
								<h4>Any Questions?</h4>
								<p>Call us on <em>1-555-555-555</em> for individual, tailored advice for your perfect stay or <a href="#" title="Contact">send us a message</a> with your hotel booking query.</p>
							</div>
						</article>
						<!--//column-->
					</div>
