      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            ...
            <?php
                $STH 			     = $DBH->prepare("select count(*) FROM login where org_id = ?");
                $result 	     = $STH->execute(array($LOGIN_ORG_ID));
                $count_users   = $STH->fetchColumn();

                $STH 			      = $DBH->prepare("select count(*) FROM hotels where org_id = ?");
                $result 	       = $STH->execute(array($LOGIN_ORG_ID));
                $count_hotels   = $STH->fetchColumn();
            ?>
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $count_hotels ?></div>
                    </div>
                    <div class="col-auto">
            ...
            <div class="col-xl-4 col-md-6 mb-4">
              <div class="card border-left-info shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Hotel Bookings</div>
